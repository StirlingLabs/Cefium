...
public struct CefRequest : ICefRefCountedBase<CefRequest> {
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, int> _IsReadOnly;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringUserFree*> _GetUrl;

  /// <summary>
  /// Set the fully qualified URL.
  /// <c>void(CEF_CALLBACK* set_url)(struct _cef_request_t* self, const cef_string_t* url);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, void> _SetUrl;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringUserFree*> _GetMethod;

  /// <summary>
  /// Set the request function type.
  /// <c>void(CEF_CALLBACK* set_method)(struct _cef_request_t* self, const cef_string_t* method);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, void> _SetMethod;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, CefReferrerPolicy, void> _SetReferrer;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringUserFree*> _GetReferrerUrl;

  /// <summary>
  /// Get the referrer policy.
  /// <c>cef_referrer_policy_t(CEF_CALLBACK* get_referrer_policy)(struct _cef_request_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefReferrerPolicy> _GetReferrerPolicy;

  /// <summary>
  /// Get the post data.
  /// <c>struct _cef_post_data_t*(CEF_CALLBACK* get_post_data)(struct _cef_request_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefPostData*> _GetPostData;

  /// <summary>
  /// Set the post data.
  /// <c>void(CEF_CALLBACK* set_post_data)(struct _cef_request_t* self, struct _cef_post_data_t* postData);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefPostData*, void> _SetPostData;

  /// <summary>
  /// Get the header values. Will not include the Referer value if any.
  /// <c>void(CEF_CALLBACK* get_header_map)(struct _cef_request_t* self, cef_string_multimap_t headerMap);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringMultimap*, void> _GetHeaderMap;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringMultimap*, void> _SetHeaderMap;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, CefStringUserFree*> _GetHeaderByName;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, CefString*, int, void> _SetHeaderByName;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, CefString*, CefPostData*, CefStringMultimap*, void> _Set;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, int> _GetFlags;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, int, void> _SetFlags;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefStringUserFree*> _GetFirstPartyForCookies;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefString*, void> _SetFirstPartyForCookies;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefResourceType> _GetResourceType;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, CefTransitionType> _GetTransitionType;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefRequest*, ulong> _GetIdentifier;
