...
public struct CefPostDataElement : ICefRefCountedBase<CefPostDataElement> {
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, int> _IsReadOnly;

  /// <summary>
  /// Remove all contents from the post data element.
  /// <c>void(CEF_CALLBACK* set_to_empty)(struct _cef_post_data_element_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, void> _SetToEmpty;

  /// <summary>
  /// The post data element will represent a file.
  /// <c>void(CEF_CALLBACK* set_to_file)(struct _cef_post_data_element_t* self, const cef_string_t* fileName);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, CefString*, void> _SetToFile;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, nuint, void*, void> _SetToBytes;

  /// <summary>
  /// Return the type of this post data element.
  /// <c>cef_postdataelement_type_t(CEF_CALLBACK* get_type)(struct _cef_post_data_element_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, CefPostDataElementType> _GetType;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, nuint> _GetBytesCount;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostDataElement*, nuint, void*, nuint> _GetBytes;
