...
public struct CefSharedMemoryRegion : ICefRefCountedBase<CefSharedMemoryRegion> {
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefSharedMemoryRegion*, int> _IsValid;

  /// <summary>
  /// Returns the size of the mapping in bytes. Returns 0 for invalid instances.
  /// <c>size_t(CEF_CALLBACK* size)(struct _cef_shared_memory_region_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefSharedMemoryRegion*, nuint> _Size;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefSharedMemoryRegion*, void*> _Memory;
