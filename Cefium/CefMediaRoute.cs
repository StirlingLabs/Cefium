...
public struct CefMediaRoute : ICefRefCountedBase<CefMediaRoute> {
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefMediaRoute*, CefStringUserFree*> _GetId;

  /// <summary>
  /// Returns the source associated with this route.
  /// <c>struct _cef_media_source_t*(CEF_CALLBACK* get_source)(struct _cef_media_route_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefMediaRoute*, CefMediaSource*> _GetSource;

  /// <summary>
  /// Returns the sink associated with this route.
  /// <c>struct _cef_media_sink_t*(CEF_CALLBACK* get_sink)(struct _cef_media_route_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefMediaRoute*, CefMediaSink*> _GetSink;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefMediaRoute*, void*, nuint, void> _SendRouteMessage;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefMediaRoute*, void> _Terminate;
