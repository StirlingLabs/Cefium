...
public static class CefSharedMemoryRegionExtensions {
  ...
  public static unsafe bool IsValid(this ref CefSharedMemoryRegion self)
    => self._IsValid is not null && self._IsValid(self.AsPointer()) != 0;

  /// <inheritdoc cref="CefSharedMemoryRegion._Size"/>
  public static unsafe nuint Size(this ref CefSharedMemoryRegion self)
    => self._Size is not null ? self._Size(self.AsPointer()) : default;

  /// <inheritdoc cref="CefSharedMemoryRegion._Memory"/>
  public static unsafe void* Memory(this ref CefSharedMemoryRegion self)
    => self._Memory is not null ? self._Memory(self.AsPointer()) : default;
