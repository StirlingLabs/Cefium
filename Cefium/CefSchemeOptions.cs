...
public enum CefSchemeOptions : int {
  ...
  /// <summary>
  /// If DISPLAY_ISOLATED is set the scheme can only be
  ...
  /// set this, set CORS_ENABLED, and use CORS
  /// "Access-Control-Allow-Origin" headers to further restrict access.
  /// </summary>
  DisplayIsolated = 1 << 2,

  /// <summary>
  /// If SECURE is set the scheme will be treated with the
  ...
  /// <summary>
  /// If CORS_ENABLED is set the scheme can be sent CORS
  ...
  /// <summary>
  /// If CSP_BYPASSING is set the scheme can bypass Content-
  ...
  /// <summary>
  /// If FETCH_ENABLED is set the scheme can perform Fetch API
  /// requests.
  /// </summary>
  FetchEnabled = 1 << 6,
