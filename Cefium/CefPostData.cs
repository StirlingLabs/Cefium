...
public struct CefPostData : ICefRefCountedBase<CefPostData> {
  ...
  public static unsafe CefPostData* CreateUndefined()
    => _Create();
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, int> _IsReadOnly;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, int> _HasExcludedElements;

  /// <summary>
  /// Returns the number of existing post data elements.
  /// <c>size_t(CEF_CALLBACK* get_element_count)(struct _cef_post_data_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, nuint> _GetElementCount;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, nuint*, CefPostDataElement**, void> _GetElements;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, CefPostDataElement*, int> _RemoveElement;
  ...
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, CefPostDataElement*, int> _AddElement;

  /// <summary>
  /// Remove all existing post data elements.
  /// <c>void(CEF_CALLBACK* remove_elements)(struct _cef_post_data_t* self);</c>
  /// </summary>
  public unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefPostData*, void> _RemoveElements;
