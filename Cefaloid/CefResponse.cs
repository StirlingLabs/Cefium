...
public struct CefResponse : ICefRefCountedBase<CefResponse> {
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, int> _IsReadOnly;

  /// <summary>
  /// Get the response error code. Returns ERR_NONE if there was no error.
  /// <c>cef_errorcode_t(CEF_CALLBACK* get_error)(struct _cef_response_t* self)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefErrorCode> _GetError;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefErrorCode, void> _SetError;

  /// <summary>
  /// Get the response status code.
  /// <c>int(CEF_CALLBACK* get_status)(struct _cef_response_t* self)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, int> _GetStatus;

  /// <summary>
  /// Set the response status code.
  /// <c>void(CEF_CALLBACK* set_status)(struct _cef_response_t* self, int status)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, int, void> _SetStatus;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringUserFree*> _GetStatusText;

  /// <summary>
  /// Set the response status text.
  /// <c>void(CEF_CALLBACK* set_status_text)(struct _cef_response_t* self, const cef_string_t* statusText)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, void> _SetStatusText;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringUserFree*> _GetMimeType;

  /// <summary>
  /// Set the response mime type.
  /// <c>void(CEF_CALLBACK* set_mime_type)(struct _cef_response_t* self, const cef_string_t* mimeType)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, void> _SetMimeType;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringUserFree*> _GetCharset;

  /// <summary>
  /// Set the response charset.
  /// <c>void(CEF_CALLBACK* set_charset)(struct _cef_response_t* self, const cef_string_t* charset)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, void> _SetCharset;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, CefStringUserFree*> _GetHeaderByName;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, CefString*, int, void> _SetHeaderByName;

  /// <summary>
  /// Get all response header fields.
  /// <c>void(CEF_CALLBACK* get_header_map)(struct _cef_response_t* self, cef_string_multimap_t headerMap)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringMultimap*, void> _GetHeaderMap;

  /// <summary>
  /// Set all response header fields.
  /// <c>void(CEF_CALLBACK* set_header_map)(struct _cef_response_t* self, cef_string_multimap_t headerMap)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringMultimap*, void> _SetHeaderMap;
  ...
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefStringUserFree*> _GetUrl;

  /// <summary>
  /// Set the resolved URL after redirects or changed as a result of HSTS.
  /// <c>void(CEF_CALLBACK* set_url)(struct _cef_response_t* self, const cef_string_t* url)</c>
  /// </summary>
  internal unsafe delegate * unmanaged[Stdcall, SuppressGCTransition]<CefResponse*, CefString*, void> _SetUrl;
